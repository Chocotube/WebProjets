...
@WebServlet({"/Chocotubevote"})
public class Chocotubevote extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		context.setAttribute("Chocotubevote", Chocotubevote);
		...
		out.println("	<h1>You voted for chocotube</h1>");
